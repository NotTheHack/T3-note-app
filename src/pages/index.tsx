  ...
  return (
    <>
      ...
      <div className="bodystyle h-screen">
        <div className="min-[768px]:py-[10%]">
          <div className="min-[768px]:flex min-[768px]:gap-4 items-center min-[768px]:px-[7%]">
            ...
            <div className="max-[425px]:hidden flex basis-1/2 p-6 min-[768px]:flex-row-reverse" >
              <Image
                src={image}
                alt="welcome"
                width={500}
          ...
          <div className="flex justify-center min-[768px]:m-10">
            <Button />
          </div>
        </div>
      </div>
